namespace WindowsFormsApp3
{
    partial class rulesForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.label2.Size = new System.Drawing.Size(540, 17);
            this.label2.TabIndex = 1;
            this.label2.Text = "* Each number (1-9) must appear exactly once in every row, column and 3x3 square." +
    "";
    ...
    "ical columns count.";
            ...
            this.label4.Text = "* A number cannot go into any cell if the same color already appears in that row," +
    " column or square.";
